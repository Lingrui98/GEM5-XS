...
struct FetchTarget
{
    ...
    // the possible new entry, set by L1BTB.getAndSetNewBTBEntry,
    // used by L1BTB/L0BTB.update
    BTBEntry updateNewBTBEntry;
         ...
         s3Source(-1)
   {
    ...
    Addr getEndPC() const { return getBranchInfo().getEnd(); }
